...
/** swig/tcl interface file for module slamseg exceptions.
 *
 * \file slamsegException.i
 * \ingroup slamseg
 */      
...
JAFAR_RUBY_EXCEPTION(Slamseg, SlamsegException);
%exception {
    try {
        $action
    }
    JAFAR_CATCH_MODULE_EXCEPTION(slamseg, SlamsegException)
    JAFAR_CATCH_GENERIC
}*/

...
/** swig/tcl interface file for module lines exceptions.
 *
 * \file linesException.i
 * \ingroup lines
 */      
...
JAFAR_RUBY_EXCEPTION(Lines, LinesException);
%exception {
    try {
        $action
    }
    JAFAR_CATCH_MODULE_EXCEPTION(lines, LinesException)
    JAFAR_CATCH_GENERIC
}

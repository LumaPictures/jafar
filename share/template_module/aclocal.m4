...
[int main() {}
	...
	MD_SHLIB_SUFFIX
        ...
        if test "$with_[$1]lib" != ""; then
            ...
            dirs="/usr/local/lib /usr/local/gnu/lib /usr/local/[$1] /usr/local/[$1]/lib /opt/lib /opt/gnu/lib /opt/[$1] /opt/[$1]/lib /usr/lib /sw /sw/lib /sw/[$1] /sw/[$1]/lib \$HOME \$HOME/lib \$HOME/[$1] \$HOME/[$1]/lib \$HOME/usr \$HOME/usr/lib \$HOME/usr/[$1] \$HOME/opt \$HOME/opt/lib \$HOME/opt/[$1]"
        fi
        found=""
        for i in $dirs; do
            if test -d $i; then
...
#include <$2>
        ...
        if test "$include_found" = ""; then
            ...
            if test "$with_[$1]inc" != ""; then
                ...
                dirs="/usr/local/include /usr/local/gnu/include /usr/local/[$1] /usr/local/[$1]/include /opt/include /opt/gnu/include /opt/[$1] /opt/[$1]/include /usr/include /sw /sw/include /sw/[$1] /sw/[$1]/include \$HOME/ \$HOME/include \$HOME/usr \$HOME/usr/include \$HOME/usr/[$1] \$HOME/opt \$HOME/opt/include \$HOME/opt/[$1] \$HOME/[$1]"
            fi
...
# Contributed by Sebastian Huber, modified by maxime cottret
...
AC_DEFUN([SWIG_PROG],[
	AC_ARG_WITH(swig,[  --with-swig=DIR	specify swig location],
	[AC_MSG_CHECKING([for swig])
	[SWIG="$withval/swig"]
	AC_MSG_RESULT([$SWIG])],[AC_PATH_PROG([SWIG],[swig])])
	if test -z "$SWIG" ; then
		...
		if test -n "$swig_version" ; then
			...
			[swig_required_version=$(( 1000000 * ${swig_tmp[0]} + 1000 * ${swig_tmp[1]:-0} + ${swig_tmp[2]:-0} ))]

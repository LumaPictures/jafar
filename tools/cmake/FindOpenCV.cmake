...
FIND_PATH(OpenCV_CXCORE_INCLUDE_DIR   
  NAMES cxcore.h cxcore.hpp
  PATHS ${OpenCV_ROOT_DIR} 
  PATH_SUFFIXES ${OpenCV_INCDIR_SUFFIXES} )
FIND_PATH(OpenCV_CVAUX_INCLUDE_DIR    
  NAMES cvaux.h cvaux.hpp
  PATHS ${OpenCV_ROOT_DIR} 
  PATH_SUFFIXES ${OpenCV_INCDIR_SUFFIXES} )
FIND_PATH(OpenCV_HIGHGUI_INCLUDE_DIR  
  NAMES highgui.h highgui.hpp
  PATHS ${OpenCV_ROOT_DIR} 
  PATH_SUFFIXES ${OpenCV_INCDIR_SUFFIXES} )
...
IF(OpenCV_VERSION_FILE)
  file(STRINGS ${OpenCV_VERSION_FILE} OpenCV_MAJOR_VERSION 
    REGEX "CV_MAJOR_VERSION.*[0-9]+")
ENDIF(OpenCV_VERSION_FILE)
#

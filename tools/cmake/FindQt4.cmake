...
IF (QT4_QMAKE_FOUND)
  ...
  IF(QT_QMAKE_CHANGED)
    FOREACH(QT_MODULE ${QT_MODULES})
      ...
      SET(Qt4_${_upper_qt_module}_INCLUDE_DIR NOTFOUND)
      SET(Qt4_${_upper_qt_module}_LIBRARY_RELEASE NOTFOUND)
      SET(Qt4_${_upper_qt_module}_LIBRARY_DEBUG NOTFOUND)
    ENDFOREACH(QT_MODULE)
    SET(Qt4_QTDESIGNERCOMPONENTS_INCLUDE_DIR NOTFOUND)
    SET(Qt4_QTDESIGNERCOMPONENTS_LIBRARY_RELEASE NOTFOUND)
    SET(Qt4_QTDESIGNERCOMPONENTS_LIBRARY_DEBUG NOTFOUND)
    SET(Qt4_QTASSISTANTCLIENT_INCLUDE_DIR NOTFOUND)
    SET(Qt4_QTASSISTANTCLIENT_LIBRARY_RELEASE NOTFOUND)
    SET(Qt4_QTASSISTANTCLIENT_LIBRARY_DEBUG NOTFOUND)
    SET(Qt4_QTASSISTANT_INCLUDE_DIR NOTFOUND)
    SET(Qt4_QTASSISTANT_LIBRARY_RELEASE NOTFOUND)
    SET(Qt4_QTASSISTANT_LIBRARY_DEBUG NOTFOUND)
    SET(Qt4_QTCLUCENE_LIBRARY_RELEASE NOTFOUND)
    SET(Qt4_QTCLUCENE_LIBRARY_DEBUG NOTFOUND)
    SET(Qt4_QAXCONTAINER_INCLUDE_DIR NOTFOUND)
    SET(Qt4_QAXCONTAINER_LIBRARY_RELEASE NOTFOUND)
    SET(Qt4_QAXCONTAINER_LIBRARY_DEBUG NOTFOUND)
    SET(Qt4_QAXSERVER_INCLUDE_DIR NOTFOUND)
    SET(Qt4_QAXSERVER_LIBRARY_RELEASE NOTFOUND)
    SET(Qt4_QAXSERVER_LIBRARY_DEBUG NOTFOUND)
    IF(WIN32)
      SET(Qt4_QTMAIN_LIBRARY_DEBUG NOTFOUND)
      SET(Qt4_QTMAIN_LIBRARY_RELEASE NOTFOUND)
    ENDIF(WIN32)
  ENDIF(QT_QMAKE_CHANGED)

  FOREACH(QT_MODULE ${QT_MODULES})
    STRING(TOUPPER ${QT_MODULE} _upper_qt_module)
    FIND_PATH(Qt4_${_upper_qt_module}_INCLUDE_DIR ${QT_MODULE}
              PATHS
  ...
  IF(WIN32)
    ...
    FIND_PATH(Qt4_QAXCONTAINER_INCLUDE_DIR ActiveQt
      PATHS
      ${QT_HEADERS_DIR}/ActiveQt
      NO_DEFAULT_PATH
      )
    FIND_PATH(Qt4_QAXSERVER_INCLUDE_DIR ActiveQt
      PATHS
      ${QT_HEADERS_DIR}/ActiveQt
      NO_DEFAULT_PATH
      )
  ...
  FIND_PATH(Qt4_QTASSISTANT_INCLUDE_DIR QAssistantClient
    PATHS
  ...
  FIND_PATH(Qt4_QTASSISTANTCLIENT_INCLUDE_DIR QAssistantClient
    PATHS
    ${QT_HEADERS_DIR}/QtAssistant
    ${QT_LIBRARY_DIR}/QtAssistant.framework/Headers
    NO_DEFAULT_PATH
  ...
  IF( Qt4_QTCORE_INCLUDE_DIR AND NOT QT_INCLUDE_DIR)
  ...
  ENDIF( Qt4_QTCORE_INCLUDE_DIR AND NOT QT_INCLUDE_DIR)
  ...
  FOREACH(QT_MODULE ${QT_MODULES})
    STRING(TOUPPER ${QT_MODULE} _upper_qt_module)
    FIND_LIBRARY(Qt4_${_upper_qt_module}_LIBRARY_RELEASE 
                 NAMES ${QT_MODULE} ${QT_MODULE}4
                 PATHS ${QT_LIBRARY_DIR} NO_DEFAULT_PATH
        )
    FIND_LIBRARY(Qt4_${_upper_qt_module}_LIBRARY_DEBUG 
  ...
  IF(Q_WS_MAC AND Qt4_QTCORE_LIBRARY_RELEASE AND NOT Qt4_QTUITOOLS_LIBRARY_RELEASE)
    FIND_LIBRARY(Qt4_QTUITOOLS_LIBRARY_RELEASE NAMES QtUiTools PATHS ${QT_LIBRARY_DIR})
  ENDIF(Q_WS_MAC AND Qt4_QTCORE_LIBRARY_RELEASE AND NOT Qt4_QTUITOOLS_LIBRARY_RELEASE)

  IF( NOT Qt4_QTCORE_LIBRARY_DEBUG AND NOT Qt4_QTCORE_LIBRARY_RELEASE )
    ...
    ENDIF(Qt4_FIND_REQUIRED)
  ENDIF( NOT Qt4_QTCORE_LIBRARY_DEBUG AND NOT Qt4_QTCORE_LIBRARY_RELEASE )

  # Set QT_QTDESIGNERCOMPONENTS_LIBRARY
  FIND_LIBRARY(Qt4_QTDESIGNERCOMPONENTS_LIBRARY_RELEASE NAMES QtDesignerComponents QtDesignerComponents4 PATHS ${QT_LIBRARY_DIR}        NO_DEFAULT_PATH)
  FIND_LIBRARY(Qt4_QTDESIGNERCOMPONENTS_LIBRARY_DEBUG   NAMES QtDesignerComponents_debug QtDesignerComponentsd QtDesignerComponentsd4 PATHS ${QT_LIBRARY_DIR} NO_DEFAULT_PATH)

  # Set QT_QTMAIN_LIBRARY
  IF(WIN32)
    FIND_LIBRARY(Qt4_QTMAIN_LIBRARY_RELEASE NAMES qtmain PATHS ${QT_LIBRARY_DIR}
      NO_DEFAULT_PATH)
    FIND_LIBRARY(Qt4_QTMAIN_LIBRARY_DEBUG NAMES qtmaind PATHS ${QT_LIBRARY_DIR}
      NO_DEFAULT_PATH)
  ENDIF(WIN32)
  
  # Set QT_QTASSISTANTCLIENT_LIBRARY
  FIND_LIBRARY(Qt4_QTASSISTANTCLIENT_LIBRARY_RELEASE NAMES QtAssistantClient QtAssistantClient4 PATHS ${QT_LIBRARY_DIR}        NO_DEFAULT_PATH)
  FIND_LIBRARY(Qt4_QTASSISTANTCLIENT_LIBRARY_DEBUG   NAMES QtAssistantClient_debug QtAssistantClientd QtAssistantClientd4 PATHS ${QT_LIBRARY_DIR} NO_DEFAULT_PATH)
  
  # Set QT_QTASSISTANT_LIBRARY
  FIND_LIBRARY(Qt4_QTASSISTANT_LIBRARY_RELEASE NAMES QtAssistantClient QtAssistantClient4 QtAssistant QtAssistant4 PATHS ${QT_LIBRARY_DIR}        NO_DEFAULT_PATH)
  FIND_LIBRARY(Qt4_QTASSISTANT_LIBRARY_DEBUG   NAMES QtAssistantClient_debug QtAssistantClientd QtAssistantClientd4 QtAssistant_debug QtAssistantd4 PATHS ${QT_LIBRARY_DIR} NO_DEFAULT_PATH)

  # Set QT_QTHELP_LIBRARY
  FIND_LIBRARY(Qt4_QTCLUCENE_LIBRARY_RELEASE NAMES QtCLucene QtCLucene4 PATHS ${QT_LIBRARY_DIR}        NO_DEFAULT_PATH)
  FIND_LIBRARY(Qt4_QTCLUCENE_LIBRARY_DEBUG   NAMES QtCLucene_debug QtCLucened QtCLucened4 PATHS ${QT_LIBRARY_DIR} NO_DEFAULT_PATH)
  # QtCLucene not with other frameworks with binary installation (in /usr/lib)
  IF(Q_WS_MAC AND Qt4_QTCORE_LIBRARY_RELEASE AND NOT Qt4_QTCLUCENE_LIBRARY_RELEASE)
    FIND_LIBRARY(Qt4_QTCLUCENE_LIBRARY_RELEASE NAMES QtCLucene PATHS ${QT_LIBRARY_DIR})
  ENDIF(Q_WS_MAC AND Qt4_QTCORE_LIBRARY_RELEASE AND NOT Qt4_QTCLUCENE_LIBRARY_RELEASE)
  ...
  MACRO (_QT4_ADJUST_LIB_VARS basename)
    IF (Qt4_${basename}_LIBRARY_RELEASE OR Qt4_${basename}_LIBRARY_DEBUG)

      # if only the release version was found, set the debug variable also to the release version
      IF (Qt4_${basename}_LIBRARY_RELEASE AND NOT Qt4_${basename}_LIBRARY_DEBUG)
        SET(Qt4_${basename}_LIBRARY_DEBUG ${Qt4_${basename}_LIBRARY_RELEASE})
        SET(Qt4_${basename}_LIBRARY       ${Qt4_${basename}_LIBRARY_RELEASE})
        SET(Qt4_${basename}_LIBRARIES     ${Qt4_${basename}_LIBRARY_RELEASE})
      ENDIF (Qt4_${basename}_LIBRARY_RELEASE AND NOT Qt4_${basename}_LIBRARY_DEBUG)

      # if only the debug version was found, set the release variable also to the debug version
      IF (Qt4_${basename}_LIBRARY_DEBUG AND NOT Qt4_${basename}_LIBRARY_RELEASE)
        SET(Qt4_${basename}_LIBRARY_RELEASE ${Qt4_${basename}_LIBRARY_DEBUG})
        SET(Qt4_${basename}_LIBRARY         ${Qt4_${basename}_LIBRARY_DEBUG})
        SET(Qt4_${basename}_LIBRARIES       ${Qt4_${basename}_LIBRARY_DEBUG})
      ENDIF (Qt4_${basename}_LIBRARY_DEBUG AND NOT Qt4_${basename}_LIBRARY_RELEASE)

      IF (Qt4_${basename}_LIBRARY_DEBUG AND Qt4_${basename}_LIBRARY_RELEASE)
        ...
        SET(Qt4_${basename}_LIBRARIES       optimized ${Qt4_${basename}_LIBRARY_RELEASE} debug ${Qt4_${basename}_LIBRARY_DEBUG})
      ENDIF (Qt4_${basename}_LIBRARY_DEBUG AND Qt4_${basename}_LIBRARY_RELEASE)

      IF(QT_QMAKE_CHANGED)
        SET(Qt4_${basename}_LIBRARY ${Qt4_${basename}_LIBRARY} CACHE STRING "The Qt ${basename} library" FORCE)
      ELSE(QT_QMAKE_CHANGED)
        SET(Qt4_${basename}_LIBRARY ${Qt4_${basename}_LIBRARY} CACHE STRING "The Qt ${basename} library")
      ENDIF(QT_QMAKE_CHANGED)
    ...
    ENDIF (Qt4_${basename}_LIBRARY_RELEASE OR Qt4_${basename}_LIBRARY_DEBUG)

    IF (Qt4_${basename}_INCLUDE_DIR)
      #add the include directory to QT_INCLUDES
      SET(QT_INCLUDES "${Qt4_${basename}_INCLUDE_DIR}" ${QT_INCLUDES})
    ENDIF (Qt4_${basename}_INCLUDE_DIR)

    # Make variables changeble to the advanced user
    MARK_AS_ADVANCED(Qt4_${basename}_LIBRARY Qt4_${basename}_LIBRARY_RELEASE Qt4_${basename}_LIBRARY_DEBUG Qt4_${basename}_INCLUDE_DIR)
  ENDMACRO (_QT4_ADJUST_LIB_VARS)


  # Set Qt4_xyz_LIBRARY variable and add 
  ...
  IF( QT_LIBRARY_DIR AND QT_INCLUDE_DIR AND QT_MOC_EXECUTABLE AND 
      QT_UIC_EXECUTABLE AND QT_RCC_EXECUTABLE AND Qt4_QTCORE_LIBRARY)
    SET( QT4_FOUND "YES" )
  ...
  SET(Qt4_QTGUI_LIB_DEPENDENCIES "")
  SET(Qt4_QTCORE_LIB_DEPENDENCIES "")
  SET(Qt4_QTNETWORK_LIB_DEPENDENCIES "")
  SET(Qt4_QTOPENGL_LIB_DEPENDENCIES "")
  SET(Qt4_QTDBUS_LIB_DEPENDENCIES "")
  SET(Qt4_QTHELP_LIB_DEPENDENCIES ${Qt4_QTCLUCENE_LIBRARY})
  ...
  SET (Qt4_QTOPENGL_LIB_DEPENDENCIES ${Qt4_QTOPENGL_LIB_DEPENDENCIES} ${QMAKE_LIBS_OPENGL})
  
  ## system png
  IF(QT_QCONFIG MATCHES "system-png")
    FIND_LIBRARY(Qt4_PNG_LIBRARY NAMES png)
    MARK_AS_ADVANCED(Qt4_PNG_LIBRARY)
    IF(Qt4_PNG_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_PNG_LIBRARY})
    ENDIF(Qt4_PNG_LIBRARY)
  ...
  IF(QT_QCONFIG MATCHES "x11sm")
    ...
    FIND_LIBRARY(Qt4_X11_SM_LIBRARY NAMES SM PATHS ${QMAKE_LIBDIR_X11})
    FIND_LIBRARY(Qt4_X11_ICE_LIBRARY NAMES ICE PATHS ${QMAKE_LIBDIR_X11})
    MARK_AS_ADVANCED(Qt4_X11_SM_LIBRARY)
    MARK_AS_ADVANCED(Qt4_X11_ICE_LIBRARY)
    IF(Qt4_X11_SM_LIBRARY AND Qt4_X11_ICE_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_X11_SM_LIBRARY} ${Qt4_X11_ICE_LIBRARY})
    ENDIF(Qt4_X11_SM_LIBRARY AND Qt4_X11_ICE_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "x11sm")
  
  ## Xi
  IF(QT_QCONFIG MATCHES "tablet")
    FIND_LIBRARY(Qt4_XI_LIBRARY NAMES Xi PATHS ${QMAKE_LIBDIR_X11})
    MARK_AS_ADVANCED(Qt4_XI_LIBRARY)
    IF(Qt4_XI_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_XI_LIBRARY})
    ENDIF(Qt4_XI_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "tablet")

  ## Xrender
  IF(QT_QCONFIG MATCHES "xrender")
    FIND_LIBRARY(Qt4_XRENDER_LIBRARY NAMES Xrender PATHS ${QMAKE_LIBDIR_X11})
    MARK_AS_ADVANCED(Qt4_XRENDER_LIBRARY)
    IF(Qt4_XRENDER_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_XRENDER_LIBRARY})
    ENDIF(Qt4_XRENDER_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "xrender")
  
  ## Xrandr
  IF(QT_QCONFIG MATCHES "xrandr")
    FIND_LIBRARY(Qt4_XRANDR_LIBRARY NAMES Xrandr PATHS ${QMAKE_LIBDIR_X11})
    MARK_AS_ADVANCED(Qt4_XRANDR_LIBRARY)
    IF(Qt4_XRANDR_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_XRANDR_LIBRARY})
    ENDIF(Qt4_XRANDR_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "xrandr")
  
  ## Xcursor
  IF(QT_QCONFIG MATCHES "xcursor")
    FIND_LIBRARY(Qt4_XCURSOR_LIBRARY NAMES Xcursor PATHS ${QMAKE_LIBDIR_X11})
    MARK_AS_ADVANCED(Qt4_XCURSOR_LIBRARY)
    IF(Qt4_XCURSOR_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_XCURSOR_LIBRARY})
    ENDIF(Qt4_XCURSOR_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "xcursor")
  
  ## Xinerama
  IF(QT_QCONFIG MATCHES "xinerama")
    FIND_LIBRARY(Qt4_XINERAMA_LIBRARY NAMES Xinerama PATHS ${QMAKE_LIBDIR_X11})
    MARK_AS_ADVANCED(Qt4_XINERAMA_LIBRARY)
    IF(Qt4_XINERAMA_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_XINERAMA_LIBRARY})
    ENDIF(Qt4_XINERAMA_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "xinerama")
  
  ## Xfixes
  IF(QT_QCONFIG MATCHES "xfixes")
    FIND_LIBRARY(Qt4_XFIXES_LIBRARY NAMES Xfixes PATHS ${QMAKE_LIBDIR_X11})
    MARK_AS_ADVANCED(Qt4_XFIXES_LIBRARY)
    IF(Qt4_XFIXES_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_XFIXES_LIBRARY})
    ENDIF(Qt4_XFIXES_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "xfixes")
  
  ## system-freetype
  IF(QT_QCONFIG MATCHES "system-freetype")
    FIND_LIBRARY(Qt4_FREETYPE_LIBRARY NAMES freetype)
    MARK_AS_ADVANCED(Qt4_FREETYPE_LIBRARY)
    IF(Qt4_FREETYPE_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_FREETYPE_LIBRARY})
    ENDIF(Qt4_FREETYPE_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "system-freetype")
  
  ## fontconfig
  IF(QT_QCONFIG MATCHES "fontconfig")
    FIND_LIBRARY(Qt4_FONTCONFIG_LIBRARY NAMES fontconfig)
    MARK_AS_ADVANCED(Qt4_FONTCONFIG_LIBRARY)
    IF(Qt4_FONTCONFIG_LIBRARY)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${Qt4_FONTCONFIG_LIBRARY})
    ENDIF(Qt4_FONTCONFIG_LIBRARY)
  ENDIF(QT_QCONFIG MATCHES "fontconfig")
  
  ## system-zlib
  IF(QT_QCONFIG MATCHES "system-zlib")
    FIND_LIBRARY(Qt4_ZLIB_LIBRARY NAMES z)
    MARK_AS_ADVANCED(Qt4_ZLIB_LIBRARY)
    IF(Qt4_ZLIB_LIBRARY)
      SET(Qt4_QTCORE_LIB_DEPENDENCIES ${Qt4_QTCORE_LIB_DEPENDENCIES} ${Qt4_ZLIB_LIBRARY})
    ENDIF(Qt4_ZLIB_LIBRARY)
  ...
  IF(QT_QCONFIG MATCHES "openssl" AND NOT Q_WS_WIN)
    ...
    IF(OPENSSL_LIBRARIES)
      SET(Qt4_QTNETWORK_LIB_DEPENDENCIES ${Qt4_QTNETWORK_LIB_DEPENDENCIES} ${OPENSSL_LIBRARIES})
  ...
  IF(QT_QCONFIG MATCHES "dbus")
    ...
    IF(NOT Qt4_DBUS_LIBRARY)
      ...
      FIND_LIBRARY(Qt4_DBUS_LIBRARY NAMES dbus-1 PATHS ${_dbus_query_output} )

      IF(Qt4_DBUS_LIBRARY)
        SET(Qt4_QTDBUS_LIB_DEPENDENCIES ${Qt4_QTDBUS_LIB_DEPENDENCIES} ${Qt4_DBUS_LIBRARY})
      ENDIF(Qt4_DBUS_LIBRARY)

      MARK_AS_ADVANCED(Qt4_DBUS_LIBRARY)
    ENDIF(NOT Qt4_DBUS_LIBRARY)
  ...
  IF(QT_QCONFIG MATCHES "glib")
    ...
    IF(NOT Qt4_GLIB_LIBRARY OR NOT Qt4_GTHREAD_LIBRARY)
      ...
      FIND_LIBRARY(Qt4_GLIB_LIBRARY NAMES glib-2.0 PATHS ${_glib_query_output} )
      FIND_LIBRARY(Qt4_GTHREAD_LIBRARY NAMES gthread-2.0 PATHS ${_glib_query_output} )
    
      MARK_AS_ADVANCED(Qt4_GLIB_LIBRARY)
      MARK_AS_ADVANCED(Qt4_GTHREAD_LIBRARY)
    ENDIF(NOT Qt4_GLIB_LIBRARY OR NOT Qt4_GTHREAD_LIBRARY)

    IF(Qt4_GLIB_LIBRARY AND Qt4_GTHREAD_LIBRARY)
      SET(Qt4_QTCORE_LIB_DEPENDENCIES ${Qt4_QTCORE_LIB_DEPENDENCIES}
          ${Qt4_GTHREAD_LIBRARY} ${Qt4_GLIB_LIBRARY})
    ENDIF(Qt4_GLIB_LIBRARY AND Qt4_GTHREAD_LIBRARY)
  ...
  IF(QT_QCONFIG MATCHES "clock-monotonic")
    ...
    CHECK_SYMBOL_EXISTS(_POSIX_TIMERS "unistd.h;time.h" Qt4_POSIX_TIMERS)
    SET(CMAKE_REQUIRED_LIBRARIES ${CMAKE_REQUIRED_LIBRARIES_SAVE})
    IF(Qt4_POSIX_TIMERS)
      FIND_LIBRARY(Qt4_RT_LIBRARY NAMES rt)
      MARK_AS_ADVANCED(Qt4_RT_LIBRARY)
      IF(Qt4_RT_LIBRARY)
        SET(Qt4_QTCORE_LIB_DEPENDENCIES ${Qt4_QTCORE_LIB_DEPENDENCIES} ${Qt4_RT_LIBRARY})
      ENDIF(Qt4_RT_LIBRARY)
    ENDIF(Qt4_POSIX_TIMERS)
  ENDIF(QT_QCONFIG MATCHES "clock-monotonic")
    
  IF(Q_WS_X11)
    # X11 libraries Qt absolutely depends on
    QT_QUERY_QMAKE(Qt4_LIBS_X11 "QMAKE_LIBS_X11")
    SEPARATE_ARGUMENTS(Qt4_LIBS_X11)
    FOREACH(Qt4_X11_LIB ${Qt4_LIBS_X11})
      STRING(REGEX REPLACE "-l" "" Qt4_X11_LIB "${Qt4_X11_LIB}")
      SET(Qt4_TMP_STR "Qt4_X11_${Qt4_X11_LIB}_LIBRARY")
      FIND_LIBRARY(${Qt4_TMP_STR} NAMES "${Qt4_X11_LIB}" PATHS ${QMAKE_LIBDIR_X11})
      MARK_AS_ADVANCED(${Qt4_TMP_STR})
      IF(${Qt4_TMP_STR})
        SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} ${${Qt4_TMP_STR}})
      ENDIF(${Qt4_TMP_STR})
    ENDFOREACH(Qt4_X11_LIB)

    QT_QUERY_QMAKE(Qt4_LIBS_THREAD "QMAKE_LIBS_THREAD")
    SET(Qt4_QTCORE_LIB_DEPENDENCIES ${Qt4_QTCORE_LIB_DEPENDENCIES} ${Qt4_LIBS_THREAD})
    
    QT_QUERY_QMAKE(QMAKE_LIBS_DYNLOAD "QMAKE_LIBS_DYNLOAD")
    SET (Qt4_QTCORE_LIB_DEPENDENCIES ${Qt4_QTCORE_LIB_DEPENDENCIES} ${QMAKE_LIBS_DYNLOAD})

  ENDIF(Q_WS_X11)
  
  IF(Q_WS_WIN)
    SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} imm32 winmm)
    SET(Qt4_QTCORE_LIB_DEPENDENCIES ${Qt4_QTCORE_LIB_DEPENDENCIES} ws2_32)
  ENDIF(Q_WS_WIN)
  
  IF(Q_WS_MAC)
    SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} "-framework Carbon")
    
    # Qt 4.0, 4.1, 4.2 use QuickTime
    IF(QT_VERSION_MINOR LESS 3)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} "-framework QuickTime")
    ENDIF(QT_VERSION_MINOR LESS 3)
    
    # Qt 4.2+ use AppKit
    IF(QT_VERSION_MINOR GREATER 1)
      SET(Qt4_QTGUI_LIB_DEPENDENCIES ${Qt4_QTGUI_LIB_DEPENDENCIES} "-framework AppKit")
    ENDIF(QT_VERSION_MINOR GREATER 1)

    SET(Qt4_QTCORE_LIB_DEPENDENCIES ${Qt4_QTCORE_LIB_DEPENDENCIES} "-framework ApplicationServices")
  ENDIF(Q_WS_MAC)

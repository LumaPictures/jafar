...
macro(BUILD_JAFAR_MODULE modulename)
  ...
  if(${NB_EXTLIBS} GREATER 0)
	...
	set(${THIS_MODULE_OPTIONAL_EXTLIBS_FLAGS} "${${THIS_MODULE_OPTIONAL_EXTLIBS_FLAGS}} -DHAVE_${THIS_OPT_BOOST_COMPONENENT}")
      else("${LIB_EXACT_NAME}" STREQUAL "Boost")
	if(("${LIB_EXACT_NAME}" STREQUAL "QT" AND QT4_FOUND) 
	    OR ("${LIB_EXACT_NAME}" STREQUAL "QT4" AND QT4_FOUND))
	  set(QT_WRAPPING_REQUIRED 1)
	  set(${THIS_MODULE_OPTIONAL_EXTLIBS_FLAGS} "${${THIS_MODULE_OPTIONAL_EXTLIBS_FLAGS}} -DHAVE_QT4")
	  list(APPEND THIS_PROJECT_DEPENDS_ALL_LIST ${QT_LIBRARIES})
	  ...
	  if(${THIS_LIB_FOUND})
	    ...
	    set(${THIS_MODULE_OPTIONAL_EXTLIBS_FLAGS} "${${THIS_MODULE_OPTIONAL_EXTLIBS_FLAGS}} -DHAVE_${THIS_OPT_LIB_NAME}")
	  else(${EXTLIB_FOUND})
